#############################################################################
# Makefile for building: mayhem-madness
# Generated by qmake (3.1) (Qt 6.2.4)
# Project:  mayhem-madness.pro
# Template: app
# Command: /usr/bin/qmake6 -o Makefile mayhem-madness.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = mayhem-madness1.0.0
DISTDIR = /home/zachary/Documents/mayhem-madness/Object_Files/mayhem-madness1.0.0
LINK          = g++
...
SOURCES       = main.cpp \
		...
		division.cpp \
		league.cpp 
OBJECTS       = Object_Files/main.o \
		Object_Files/team.o \
		Object_Files/division.o \
		Object_Files/league.o
DIST          = /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		...
		mayhem-madness.pro team.h \
		division.h \
		league.h main.cpp \
		team.cpp \
		division.cpp \
		league.cpp
QMAKE_TARGET  = mayhem-madness
DESTDIR       = 
TARGET        = mayhem-madness


first: all
####### Build rules

mayhem-madness:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: mayhem-madness.pro /usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile mayhem-madness.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents team.h division.h league.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp team.cpp division.cpp league.cpp $(DISTDIR)/
...
Object_Files/main.o: main.cpp league.h \
		division.h \
		team.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Object_Files/main.o main.cpp

Object_Files/team.o: team.cpp team.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Object_Files/team.o team.cpp

Object_Files/division.o: division.cpp division.h \
		team.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Object_Files/division.o division.cpp

Object_Files/league.o: league.cpp league.h \
		division.h \
		team.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Object_Files/league.o league.cpp
